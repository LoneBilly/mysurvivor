...
const Admin = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'buildings':
        return <BuildingManager buildings={buildings} onBuildingsUpdate={fetchAdminData} allItems={items} />;
      case 'auctions':
        ...
        {isMobile ? (
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full flex flex-col flex-1 min-h-0">
            ...
            <TabsContent value="buildings" className="flex-1 min-h-0">
              <BuildingManager buildings={buildings} onBuildingsUpdate={fetchAdminData} allItems={items} />
            </TabsContent>
