...
import ZoneItemEditorModal from "@/components/admin/ZoneItemEditorModal";
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-gray-400 mt-1">Glissez-déposez pour réorganiser. Cliquez sur une zone pour éditer ses objets.</p>
            </div>
