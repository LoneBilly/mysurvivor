      ...
      <section className="w-full max-w-5xl text-center py-16 sm:py-24">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-4">
          <Button 
            ...
            className="w-full sm:w-auto rounded-none border-2 border-black shadow-[4px_4px_0px_#000] bg-red-500 text-white font-bold text-lg px-12 py-6 transition-all hover:bg-red-600 hover:shadow-[6px_6px_0px_#000] active:shadow-none active:translate-x-[4px] active:translate-y-[4px]"
          >
