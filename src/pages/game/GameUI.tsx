...
import FactionScoutsModal from "../../components/FactionScoutsModal";
...
import CrossbowModal from "../../components/CrossbowModal";
  ...
  return (
    <div className="h-full flex flex-col text-white">
      ...
      <TrapModal
        ...
        onClose={() => { setIsTrapModalOpen(false); setInspectedConstruction(null); }}
        construction={inspectedConstruction}
        onDemolish={handleDemolishBuilding}
      ...
      <CrossbowModal
        ...
        onClose={() => { setIsCrossbowModalOpen(false); setInspectedConstruction(null); }}
        construction={inspectedConstruction}
        onDemolish={handleDemolishBuilding}
        onUpdate={refreshPlayerData}
      />
