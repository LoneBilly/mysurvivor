...
export const IconCombobox = ({ value, onChange }: IconComboboxProps) => {
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-full justify-between bg-gray-900 border-gray-700 hover:bg-gray-800"
        >
          {value ? value : "Sélectionner une icône..."}
