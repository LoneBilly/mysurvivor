...
const ItemFormModal = ({ isOpen, onClose, item, onSave }: ItemFormModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-slate-900 border-slate-700 text-slate-100 rounded-lg shadow-lg">
        <DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                className="col-span-3 bg-slate-800 border-slate-600 text-slate-50"
                required
                disabled={loading}
              />
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select value={type} onValueChange={setType} disabled={loading}>
                <SelectTrigger className="col-span-3 bg-slate-800 border-slate-600 text-slate-50">
