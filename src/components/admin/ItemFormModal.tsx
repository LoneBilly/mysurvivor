  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-slate-900/80 backdrop-blur-sm border border-cyan-400/50 rounded-lg shadow-lg shadow-cyan-500/10 text-slate-100 p-6">
        <DialogHeader>
          <DialogTitle className="text-cyan-400">{item ? 'Modifier l\'objet' : 'Créer un nouvel objet'}</DialogTitle>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                className="col-span-3 bg-slate-800 border-slate-700 text-slate-100 focus:border-cyan-500 focus:ring-cyan-500"
                required
                disabled={loading}
              />
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Select value={type} onValueChange={setType} disabled={loading}>
                <SelectTrigger className="col-span-3 bg-slate-800 border-slate-700 text-slate-100 focus:ring-cyan-500">
          ...
          <DialogFooter>
            <Button type="submit" disabled={loading || nameExists && name !== item?.name || !name.trim() || !type.trim()} className="bg-cyan-600 hover:bg-cyan-700">
