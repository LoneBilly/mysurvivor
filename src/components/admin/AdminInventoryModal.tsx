              ...
              <div className="max-h-[60vh] overflow-y-auto pr-2">
                <div className="grid grid-cols-[repeat(auto-fill,minmax(5.5rem,1fr))] gap-3">
                  {inventory.map(invItem => (
                    <div key={invItem.id} className="relative group bg-slate-700/50 p-2 rounded-lg border border-slate-600 w-full aspect-square flex flex-col items-center justify-center text-center">
                  ...
                  <button onClick={() => setIsAddModalOpen(true)} className="border-2 border-dashed border-slate-600 rounded-lg flex flex-col items-center justify-center text-slate-400 hover:bg-slate-700/50 hover:text-white transition-colors w-full aspect-square">
