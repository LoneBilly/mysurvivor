          ...
          {isMobile ? (
            <div className="p-4 space-y-3">
              {sortedPlayers.map(player => (
                <Card key={player.id} onClick={() => openPlayerDetails(player)} className="bg-gray-800/60 border-gray-700 cursor-pointer">
                  <CardContent className="p-3">
                    <p className="font-bold text-white">{player.username || 'Anonyme'}</p>
