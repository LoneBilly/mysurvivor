        ...
        <DialogContent className="sm:max-w-md bg-slate-800/70 backdrop-blur-lg text-white border border-slate-700 shadow-2xl rounded-2xl p-6">
          ...
          <div className="py-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <select onChange={(e) => handleRoleChange(e.target.value as 'player' | 'admin')} value={player.role} className="w-full sm:w-[200px] bg-gray-900/50 border-gray-600 p-2 rounded-lg">
            ...
            <div className="flex items-center gap-3">
              ...
              <select 
                ...
                className="w-full bg-gray-900/50 border-gray-600 p-2 rounded-lg"
              >
