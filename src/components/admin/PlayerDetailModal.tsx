          ...
          <div className="py-4 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                value={player.role}
                className="w-full sm:w-[200px] bg-gray-900/50 border-gray-600 px-3 h-10 rounded-lg text-white focus:ring-indigo-500 focus:border-indigo-500"
              >
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="w-full bg-gray-900/50 border-gray-600 px-3 h-10 rounded-lg text-white focus:ring-indigo-500 focus:border-indigo-500"
              >
