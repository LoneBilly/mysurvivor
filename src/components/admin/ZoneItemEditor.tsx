      ...
      <CardHeader className="flex-shrink-0 border-b border-gray-700 p-4">
        ...
        <div className="mt-4">
          ...
          <select
            ...
            className="w-full mt-1 bg-gray-900/50 border-gray-600 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="flex w-full sm:w-auto gap-3">
            <select
              ...
              className="w-full sm:w-[180px] bg-gray-900/50 border-gray-600 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
