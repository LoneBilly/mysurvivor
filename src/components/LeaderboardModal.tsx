...
const LeaderboardModal = ({ isOpen, onClose }: LeaderboardModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="relative sm:max-w-lg bg-slate-900/80 backdrop-blur-md border border-cyan-400/30 rounded-lg shadow-lg shadow-cyan-500/20 text-white p-6 overflow-hidden">
        ...
        <DialogHeader className="text-center mb-4">
          ...
          <DialogTitle className="text-cyan-300 font-mono tracking-wider uppercase text-xl">Classement</DialogTitle>
