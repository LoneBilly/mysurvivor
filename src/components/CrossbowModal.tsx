          ...
          {selectedArrowStack ? (
            <div className="space-y-4 p-4 bg-white/5 rounded-lg">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Button onClick={handleLoadArrows} disabled={loading} className="flex-1">
            ...
            <div className="space-y-2">
              <p className="text-center text-sm text-gray-400">Charger des flèches depuis l'inventaire</p>
