...
const GameGrid = ({ mapLayout, onCellSelect, discoveredZones, playerPosition, basePosition }: GameGridProps) => {
  ...
  return (
    <>
      <div
        className="bg-white/10 backdrop-blur-lg max-w-full max-h-full aspect-square flex items-center justify-center border border-white/20 shadow-2xl rounded-2xl m-2"
