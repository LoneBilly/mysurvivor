...
const GameGrid = ({ onCellSelect, discoveredZoneIds, playerPosition, basePosition }: GameGridProps) => {
  ...
  return (
    <div className="bg-gray-800 p-1 md:p-2 rounded-lg shadow-lg flex items-center justify-center w-full max-w-[calc(100%-20px)] max-h-[calc(100%-20px)] aspect-square">
      {loading ? (
