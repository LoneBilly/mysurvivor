  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        ...
        <div
          ref={gridRef}
          className="grid [grid-template-columns:repeat(auto-fill,minmax(4.5rem,1fr))] gap-2 p-2 sm:p-4 bg-slate-900/50 rounded-lg border border-slate-800 max-h-[50vh] overflow-y-auto relative"
        >
          {loading ? (
