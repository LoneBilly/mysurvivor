  ...
  return (
    <div className="h-full flex flex-col text-white">
      <GameHeader 
        ...
        credits={playerData.playerState.credits} // Pass credits
        onPurchaseCredits={() => setIsPurchaseModalOpen(true)} // Pass onPurchaseCredits
      />
      <main className="flex-1 min-h-0 overflow-hidden relative">
        {/* Removed CreditsDisplay from here */}
      ...
      <PatchnoteModal isOpen={isPatchnoteOpen} onClose={() => setIsPatchnote(false)} />
    </div>
  );
};
