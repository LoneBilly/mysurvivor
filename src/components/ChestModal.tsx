  ...
  const renderGrid = (title: string, items: (InventoryItem | null)[], totalSlots: number, type: 'inventory' | 'chest') => {
    ...
    return (
      <div className="flex flex-col min-h-0">
        ...
        <div className="flex-grow bg-black/20 rounded-lg p-2 border border-slate-700 grid [grid-template-columns:repeat(auto-fill,minmax(4rem,1fr))] gap-2 content-start overflow-y-auto no-scrollbar">
